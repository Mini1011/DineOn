...
const Header=()=>{
    ...
    return (
        <div className="flex items-center justify-between shadow-lg h-24 fixed top-0 w-[100%] bg-white z-[1]">
            <div className="w-[160px] h-16 p-4 m-4 ml-[40px] bg-white flex justify-center items-center rounded-xl border-2 border-orange-500">
                <h1 className="text-3xl font-bold text-orange-500" >DineOn</h1>
            </div>
